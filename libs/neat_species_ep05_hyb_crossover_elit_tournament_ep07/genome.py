...
class DefaultGenome(DefaultGenome):
    ...
    def configure_crossover(self, genome1, genome2, config, first_half=True):
        ...
        crossover_rate = 0.5 if first_half else 0.3
        for key, cg1 in parent1.connections.items():
            ...
            if cg2 is None:
                ...
                self.connections[key] = cg1.crossover(cg2, crossover_rate)
        # Inherit node genes
        ...
        for key, ng1 in parent1_set.items():
            ...
            if ng2 is None:
                ...
                # Homologous gene: combine genes from both parents.
                self.nodes[key] = ng1.crossover(ng2, crossover_rate)
