...
class NoveltyArchive(BaseArchive):
    def __init__(self, config, size=500, pre_train=False):
        ...
        # オプティマイザの設定
        # self.optimizer_learned = optim.Adam(self.learned_encoder.parameters(), lr=0.01)
        self.optimizer_learned = optim.RAdam(self.learned_encoder.parameters(), lr=0.01)
        self.optimizer_random = optim.Adam(self.random_encoder.parameters(), lr=0.01)
