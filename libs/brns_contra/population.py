    ...
    def run(self, evaluate_function, constraint_function=None, n=None):
        ...
        while n is None or k < n:
            ...
            self.population = self.reproduction.reproduce(
                self.config, self.novelty_archive, self.config.pop_size, self.generation)
            ...
            self.archive_reporter.post_evaluate(self.novelty_archive, self.generation)
...
class archive_reporter:
    ...
    def post_evaluate(self, novelty_archive, generation):
