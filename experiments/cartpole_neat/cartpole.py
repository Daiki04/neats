...
ENV_DIR = os.path.join(ROOT_DIR, 'envs', 'cartpole') # 環境のディレクトリ
...
def main():
    ...
    config_file = os.path.join(CURR_DIR, 'config', 'cartpole.cfg')
    custom_config = [
