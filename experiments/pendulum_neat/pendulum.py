...
ENV_DIR = os.path.join(ROOT_DIR, 'envs', 'pendulum') # 環境のディレクトリ
...
def main():
    ...
    config_file = os.path.join(CURR_DIR, 'config', 'pendulum.cfg')
    custom_config = [
    ...
    config_out_file = os.path.join(save_path, 'pendulum.cfg')
