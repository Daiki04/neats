...
def main():
    ...
    save_path = os.path.join(CURR_DIR, 'out', 'doublependulum', args.name) # 結果の保存先
    ...
    evaluator = DoublePendulumControllerEvaluator_KAN(env) # 評価器
    ...
    config_file = os.path.join(CURR_DIR, 'config', 'doublependulum_kan.cfg')
    custom_config = [
